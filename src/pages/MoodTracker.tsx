...
const moodOptions = [
  ...
  { value: "loved/horny[state]", label: "Loved / Horny [state]", icon: Heart, color: "text-pink-500" },
  ...
  { value: "sad/Angry[state]", label: "Sad / Angry [state]", icon: Frown, color: "text-blue-600" },
];
...
export default MoodTracker;import { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";
import { supabase } from "@/integrations/supabase/client";
import { useToast } from "@/hooks/use-toast";
import Navigation from "@/components/Navigation";
