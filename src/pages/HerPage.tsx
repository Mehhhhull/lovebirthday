        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            ...
            >
              <Card className="gradient-card shadow-soft border-0 p-6 text-center hover:shadow-dreamy transition-smooth group cursor-pointer">
                ...
                <h3 className="font-display font-semibold mb-2">Song Dedicated to You</h3>
                <p className="text-sm text-foreground/70">Listen to this special tune made just for you</p>
              </Card>
            </a>
            ...
            <Card className="gradient-card shadow-soft border-0 p-6 text-center hover:shadow-dreamy transition-smooth group cursor-pointer">
              ...
              <p className="text-sm text-foreground/70">Watch this heartfelt video created only for you</p>
            </Card>
          </div>
          ...
          <Card className="gradient-card shadow-dreamy border-0 p-8 md:p-10 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="font-display text-2xl font-bold">Things About You</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-4">
              {quirks.map((quirk, index) => (
                <div key={index} className="flex items-start gap-3 p-4 rounded-2xl bg-white/40 hover:bg-white/60 transition-smooth">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: "0.6s" }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {galleryMedia.map((item, index) => {
                const isVideo = item.endsWith(".mp4"); // check file type
                return (
                  <div key={index} className="aspect-square rounded-2xl overflow-hidden shadow-soft hover:shadow-dreamy transition-smooth hover:scale-105">
                    {isVideo ? (
                      <video
                        src={item}
                        autoPlay
          ...
          <Card className="gradient-card shadow-dreamy border-0 p-8 md:p-10 animate-fade-in-up" style={{ animationDelay: "0.8s" }}>
            ...
            <div className="prose prose-lg max-w-none text-foreground/80">
              ...
              <p className="leading-relaxed mb-4">
                Every day with you feels like a gift I never knew I was waiting for. The time and the nights and the moments i dont want to pass when i am with you(but you sleep💀). I want to protect and cherish and pamper you like a child foreverrr forever.
              </p>
              <p className="leading-relaxed mb-4">
              ...
              <p className="leading-relaxed mb-4">
                Thank you for being you. Thank you for choosing us. I promise to love you with everything I have, today and always.
              </p>
